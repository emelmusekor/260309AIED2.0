...
MAX_CARD_TAGS = 8
UI = {
    'ko': {'menuLabel':'메뉴','previewLabel':'핵심 요약','pagesLabel':'페이지 원본 보기','pageModalTitle':'페이지 원본','keywordModalTitle':'키워드','closeLabel':'닫기','keywordExcerptLabel':'원문 근거','keywordUsedLabel':'원문 사용 위치','pagesFactLabel':'원본 범위','coverageFactLabel':'분량','browseLabel':'목차부터 보기','jumpLabel':'본문 바로 보기','infoLabel':'정보','graphLabel':'키워드 네트워크','searchPlaceholder':'검색어로 장, 카드, 해시태그 찾기','searchClearLabel':'초기화','searchDefaultLabel':'전체 내용을 보고 있습니다.','searchEmptyLabel':'일치하는 결과가 없습니다.','searchResultsPattern':'{count}개 결과','fallback':'이 구간은 원문 페이지에서 바로 확인할 수 있습니다.','worksheetLabel':'학생 입력 워크북','worksheetOpenLabel':'직접 입력써보기','worksheetSharedLabel':'공통 정보','worksheetPagesLabel':'페이지별 직접 입력','worksheetTeacherLabel':'선생님 메일','worksheetTeacherPlaceholder':'teacher@example.com','worksheetMailButtonLabel':'메일 보내기','worksheetDownloadLabel':'입력한 내용으로 PDF 내려받기','worksheetResetLabel':'입력 지우기','worksheetEmptyLabel':'이 페이지는 입력칸이 없습니다.','worksheetFieldsPattern':'입력칸 {count}개','worksheetNotice':'워크북은 페이지별로 따로 열어 입력하고, 입력 내용은 브라우저 안에서만 처리됩니다.','worksheetMailHint':'메일 보내기는 지원 브라우저에서는 PDF 첨부 공유를 시도하고, 그렇지 않으면 PDF를 내려받은 뒤 메일 초안을 엽니다.','worksheetDownloadBusyLabel':'PDF 만드는 중...','worksheetMailBusyLabel':'메일 준비 중...','worksheetMailFallbackLabel':'이 브라우저에서는 메일 첨부 공유를 바로 지원하지 않아 PDF를 먼저 내려받고 메일 초안을 엽니다.'},
